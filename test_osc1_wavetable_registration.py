"""Test that OSC1.Wavetable is properly registered and resolvable."""
import sys
import pickle
...
print("=" * 80)
print("16.5.52.D: OSC1.Wavetable Semantic Registration Test")
print("=" * 80)
print()

# Step 1: Check registration
print("[STEP 1] Check semantic target registration")
if "OSC1.Wavetable" in SEMANTIC_TARGETS:
    ref = SEMANTIC_TARGETS["OSC1.Wavetable"]
    print(f"  [PASS] OSC1.Wavetable registered")
    print(f"    - Semantic name: {ref.name}")
    print(f"    - Capability key: {ref.capability_key}")
else:
    print(f"  [FAIL] OSC1.Wavetable NOT registered")
    sys.exit(1)
...
resolved2 = resolve_semantic_target("OSC1.Wavetable", contracts)
...
if dry_result.accepted:
    print(f"  [PASS] Admission ACCEPTED for OSC1.Wavetable")
...
print()
print("=" * 80)
print("[PASS] DECISION: OSC1_WAVETABLE_SEMANTIC_REGISTRATION_VERIFIED")
print("=" * 80)
